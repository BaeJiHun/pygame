...
# pos_x = random.randint(0, screen_height/2)
# pos_y = random.randint(0, screen_width/2)
# # 적군 캐릭터
# enemy = pygame.image.load("D:/jihoon_python/python_game/DDONG.png")
...
enemy = pygame.image.load("D:/jihoon_python/python_game/DDONG.png")
enemy_1 = pygame.image.load("D:/jihoon_python/python_game/DDONG.png")

def postion(enemy, screen_width, screen_height):
    enemy_size = enemy.get_rect().size  # 이미지 크기
    enemy_width = enemy_size[0]  # 캐릭터 가로크기
    enemy_height = enemy_size[1]  # 캐릭터 세로크기
    enemy_y_pos = random.randint(0, screen_height/2)
    enemy_x_pos = random.randint(0, screen_width/2)
    return enemy_y_pos, enemy_x_pos

enemy_y_pos, enemy_x_pos = postion(enemy, screen_width, screen_height)
